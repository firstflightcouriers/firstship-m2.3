...
class NewAction extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Firstflight_Firstship::region_create';
    ...
    public function execute()
    {
        ...
        if (!empty($FormData)) {
            ...
            $this->coreRegistry->register('firstflight_region', $model);
        }

        $countryHelper = $this->_objectManager->get(\Magento\Directory\Model\Config\Source\Country::class);

        $this->coreRegistry->register('firstflight_region_country_list', $countryHelper->toOptionArray());
